...
| resourceMetricsEnabled            | boolean, _true_               |                       | Enable per-action resource utilization collection (CPU time, peak memory). The worker polls /proc during execution and records results in auxiliaryMetadata. Disable to avoid the monitoring overhead.                                                                                                                   |
